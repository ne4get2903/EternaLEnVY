                            ...
                            <table class="table table-striped table-bordered dataTable no-footer" id="datatable" role="grid" aria-describedby="datatable_info" >
                                  <thead>
                                    <tr role="row">
                                      ...
                                      <th tabindex="0" class="sorting" aria-controls="datatable" style="width: 161px;" aria-label="Rule: activate to sort column ascending" rowspan="1" colspan="1">Số report</th>
                                  ...
                                  foreach ($list as $key => $value) {
                                    ...
                                    <tr class="odd" role="row">
                                      ...
                                      <td><a href="#" "Xem nội dung vi phạm"><?php echo $value->count_report ?></a></td>
